import{k as z,x as W,G as Z}from"./trescientos-CnEOmf0U.js";import{E as g,b,c as R}from"./index-CPSTaPT5.js";import{_ as $,r as p,A as M,e as q,w as J,z as v,o as _,d as T,i as t,h as n,a as D,F as I,x as E,g as a,t as L,j as C,u as P,p as K,l as O}from"./index-C0nZSgCS.js";const V=u=>(K("data-v-dc28537f"),u=u(),O(),u),Q=V(()=>a("TresPerspectiveCamera",{position:[0,0,5]},null,-1)),X=V(()=>a("TresAxesHelper",{args:[2]},null,-1)),Y=V(()=>a("TresBoxGeometry",{args:[2,2,2]},null,-1)),N=`
varying vec2 UV;
void main() {
    UV = uv;
