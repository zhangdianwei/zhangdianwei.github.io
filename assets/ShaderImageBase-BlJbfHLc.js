import{N as H,k as z,x as $,G as q}from"./trescientos-C4XzamHU.js";import{E as g,b as B,c as b}from"./index-CPSTaPT5.js";import{_ as J,r as x,A as I,f as K,w as O,z as d,o as v,h as R,j as o,e as l,a as W,F as M,x as T,d as r,t as N,k as h,u as E,p as Q,l as X}from"./index-BvxA47Bm.js";const C=f=>(Q("data-v-550b1763"),f=f(),X(),f),Y=C(()=>r("TresPerspectiveCamera",{position:[0,0,5]},null,-1)),Z=C(()=>r("TresAxesHelper",{args:[2]},null,-1)),ee=C(()=>r("TresBoxGeometry",{args:[2,3.6,2]},null,-1)),L=`
varying vec2 UV;
void main() {
    UV = uv;
...
`,te={__name:"ShaderImageBase",setup(f){const{onLoop:j}=q(),V=[{name:"显示图像",children:[{name:"显示图像",frag:`
varying vec2 UV;
