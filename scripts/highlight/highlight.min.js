...
;hljs.registerLanguage("python",e)})();/*! `glsl` grammar compiled for Highlight.js 11.5.1 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `javascript` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
