...
import { appear, disappear, makeButton, scaleOnce } from './Game2048UI.js'
...
export default class StartDialog extends Dialog {
    ...
    createTitle() {
        const title = new PIXI.Text('数字贪吃蛇', {
            fontFamily: 'Arial',
            fontSize: 120,
            fontWeight: 'bold',
            fill: 0xffffff,
    ...
    createCounterButton() {
        ...
        descBtn.hitArea = new PIXI.Rectangle(
            -descBtnWidth / 2 - 20,
            -descBtnHeight / 2 - 20,
            descBtnWidth + 40,
            descBtnHeight + 40,
    ...
    createStartButton() {
        ...
        makeButton(startBtn, async () => {
            ...
            if (!this.disposed) this.app.dialogMgr.replace(PlayDialog, this.counter)
        })
    }
}
