...
@media (max-width:720px) { .mahjong-shell { height:100dvh; height:calc(var(--app-vh, 1vh) * 100); min-height:0; display:flex; flex-direction:column; padding:0; }.mahjong-topbar { flex:none; grid-template-columns:1fr auto; border:0; border-radius:0; }.mahjong-status { display:none; }.mahjong-tools :deep(.ivu-btn) { width:40px; padding:0; }.mahjong-table { width:100%; min-height:0; flex:1; border-radius:0; }.mahjong-table::before { right:18px; bottom:198px; font-size:82px; }.seat-top { top:12px; }.seat-top .player-name { display:none; }.seat-left,.seat-right { top:40%; }.seat-left { left:9px; }.seat-right { right:9px; }.seat-left .wind,.seat-right .wind { display:none; }.tile-backs i { width:22px; height:32px; }.backs-top { top:46px; }.backs-top i:nth-child(n+12) { display:none; }.backs-side i { width:32px; height:22px; margin-top:-6px; }.backs-side i:nth-child(n+10) { display:none; }.turn-console { top:40%; width:120px; min-height:132px; }.discards { width:102px; gap:2px; }.discards-2 { top:112px; }.discards-3,.discards-1 { top:38%; width:50px; }.discards-3 { left:47px; }.discards-1 { right:47px; }.discards-0 { bottom:210px; }.mini-slot { width:23px; height:32px; }.melds-2 { top:86px; }.melds-3 { top:80px; left:8px; }.melds-1 { top:80px; right:8px; }.self-player { left:9px; bottom:161px; }.self-player .wind,.self-player .player-name { display:none; }.self-melds { left:49px; bottom:162px; }.action-dock { right:8px; bottom:160px; }.action-dock :deep(.ivu-btn) { min-width:40px; height:40px; padding:0 11px; }.hand-zone { min-height:153px; padding:8px 4px 9px; }.human-hand { width:308px; flex-wrap:wrap; gap:2px; margin:0 auto; }.hand-slot { width:39px; height:53px; } }
